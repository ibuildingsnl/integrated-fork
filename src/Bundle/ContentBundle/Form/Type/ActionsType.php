...
class ActionsType extends BaseActionsType
{
    ...
    public function __construct()
    {
        parent::__construct([
            ...
            'save' => ['type' => SubmitType::class, 'options' => ['label' => 'Update', 'button_class' => 'green']],
            ...
            'cancel' => ['type' => SubmitType::class, 'options' => ['label' => 'Back', 'button_class' => 'gray-thin', 'attr' => ['formnovalidate' => 'formnovalidate', 'data-dismiss' => 'modal']]],
        ]);
    }
