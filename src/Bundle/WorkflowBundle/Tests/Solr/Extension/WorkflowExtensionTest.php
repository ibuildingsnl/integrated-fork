...
class WorkflowExtensionTest extends \PHPUnit\Framework\TestCase
{
    ...
    public static function buildProvider()
    {
        return [
            [
                self::getState(),
                ['workflow_deadline' => [0 => 2], 'workflow_state' => [0 => ''], 'facet_workflow_state' => [0 => '']],
            ],
            [
            ...
            [
                ...
                ['security_workflow_read' => ['group1'], 'security_workflow_write' => ['group2'], 'workflow_deadline' => [0 => 2], 'workflow_state' => [0 => ''], 'facet_workflow_state' => [0 => '']],
            ],
            [
                self::getState([self::getPermission('group1', false, false), self::getPermission('group2', true, true)]),
                ['security_workflow_read' => ['group2'], 'security_workflow_write' => ['group2'], 'workflow_deadline' => [0 => 2], 'workflow_state' => [0 => ''], 'facet_workflow_state' => [0 => '']],
            ],
            [
                self::getState([self::getPermission('group1', true, true), self::getPermission('group2', true, true)]),
                ['security_workflow_read' => ['group1', 'group2'], 'security_workflow_write' => ['group1', 'group2'], 'workflow_deadline' => [0 => 2], 'workflow_state' => [0 => ''], 'facet_workflow_state' => [0 => '']],
            ],
            [
                self::getState([self::getPermission('group1', true, false), self::getPermission('group2', false, false)]),
                ['security_workflow_read' => ['group1'], 'workflow_deadline' => [0 => 2], 'workflow_state' => [0 => ''], 'facet_workflow_state' => [0 => '']],
            ],
            [
                self::getState([self::getPermission('group1', false, false), self::getPermission('group2', false, true)]),
                ['security_workflow_write' => ['group2'], 'workflow_deadline' => [0 => 2], 'workflow_state' => [0 => ''], 'facet_workflow_state' => [0 => '']],
            ],
        ];
    }
